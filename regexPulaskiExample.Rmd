...
bosMainPaige = htmlParse(rooturl)
links = xpathSApply(bosMainPaige, "//a/@href")
links
```

The above code downloads the html for the Board's website and saves it in bosMainPaige. The next line extracts all the links leading away from that page. It looks like a promising place to look is in the links such as 'Board-of-Supervisors-Minutes-1992.html'. We can get just those links with the following
